...
class WebGPUBuffer:
    ...
    def to_numpy(self) -> np.ndarray:
        """Read buffer back to CPU as raw uint8. Slow — debug and logit readback only.

        Callers must apply .view() to convert to typed dtype if needed.
        """
        import wgpu
